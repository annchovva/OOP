...
namespace MyPaint.Plugins
{
    public class Rectangle : IFigure
    {
        ...
        public void OnMouseMove(int x, int y, Graphics graphics)
        {
            ...
            {
                graphics.FillRectangle(brush, x_start, y_start, width, height);
            }
            using (Pen pen = new Pen(this.BorderColor, this.Thickness))
            {
                graphics.DrawRectangle(pen, x_start, y_start, width, height);
            }
        ...
        public void Draw(Graphics graphics)
        {
            ...
            using (Brush brush = new SolidBrush(this.Color))
            {
                graphics.FillRectangle(brush, -half_x, -half_y, Width, Height);
            }
            using (Pen pen = new Pen(this.BorderColor, this.Thickness))
            {
                graphics.DrawRectangle(pen, -half_x, -half_y, Width, Height);
            }
